...
describe('extractVideoId', () => {
  ...
  it.each([
    ...
    [`https://youtube.evil.co/watch?v=${ID}`, '把 youtube 当子域的攻击者域名'],
    [`https://youtube.evil.com/watch?v=${ID}`, 'youtube.<攻击者>.com'],
    [`https://youtube.com.evil.co/watch?v=${ID}`, '把 youtube.com 当子域的攻击者域名'],
